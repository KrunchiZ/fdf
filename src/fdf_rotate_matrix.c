...
/*   Updated: 2025/09/06 04:43:56 by kchiang          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	calc_rotate_matrix(t_mod *mod)
{
	...
	multiply_matrix
		(mod->rotate_matrix.ab, mod->rotate_matrix.z, mod->rotate_matrix.x);
	multiply_matrix
		(mod->rotate_matrix.abc, mod->rotate_matrix.ab, mod->rotate_matrix.y);
	return ;
}
